...
cutoff_left = center - 0.5 * cutoff_width
cutoff_right = center + 0.5 * cutoff_width
cutoff_bottom = ground - cutoff_depth
...
vertices = [
    ...
    [cutoff_left, ground],
    [cutoff_right, ground],
    [cutoff_left, cutoff_bottom],
    [cutoff_right, cutoff_bottom],
]
...
regions = [
    [0.1, 0.1],
    [center, ground + 0.25],
    [center, 0.5 * (ground + cutoff_bottom)],
]
regionFlags = [1, 2, 3]
