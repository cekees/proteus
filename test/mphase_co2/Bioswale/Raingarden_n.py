...
atol_u[0] = 1.0e-3
rtol_u[0] = 1.0e-3
# Phase B Step 1: tolerances for component 1 (S_w). Equation is trivial,
# so any sane tolerance works; mirror component 0 for symmetry.
atol_u[1] = 1.0e-3
rtol_u[1] = 1.0e-3
...
nDTout = 201
DT = T/nDTout                                            # ≈ 2.5e-3
tnList = [0.0, 1e-8, 2e-8] + [i*DT for i in range(1, nDTout+2)]
