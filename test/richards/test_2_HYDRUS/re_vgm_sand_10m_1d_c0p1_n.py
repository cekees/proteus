...
tnList = [0.0]; nDTout = 1000 #1000#cek don't have stability worked out yet, blows up for large time steps
...
if useFLCBDF:
    ...
    #nDTout = 1#int(T/DT)#int(T/DT) #100#int(T/DT)
    #for controlling time stepping
    nonlinearIterationsFloor = 8
    nonlinearIterationsCeil  = 16
    dtNLgrowFactor = 2
...
#nn=101
#nLevels = 4
nn= 101#dz = 0.2 m over the 20 m column, matching the HYDRUS nodes
nLevels = 1#10-2
#nn=3
#nLevels = 10
