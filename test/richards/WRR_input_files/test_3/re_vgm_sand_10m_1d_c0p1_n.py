...
# T/nDTout = 1.25e-4 d = 0.003 h, inside the 0.01 h ceiling the paper uses.
...
# Grid sweep of Table 4.  The 1-D mesh puts nodes on both boundaries, so
# nn = L[0]/dz + 1:
#     dz = 0.50 m (50 cm) -> nn =    11
#     dz = 0.20 m (20 cm) -> nn =    26
#     dz = 0.10 m (10 cm) -> nn =    51
#     dz = 0.05 m ( 5 cm) -> nn =   101
#     dz = 0.01 m ( 1 cm) -> nn =   501
#     dz = 0.0005 m (0.05 cm) -> nn = 10001   reference solution
dz = 0.5
nn = int(round(L[0]/dz)) + 1
nLevels = 1#10-2
#nn=3
#nLevels = 10
