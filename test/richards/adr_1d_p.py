...
from proteus.richards import ADR
nd = 1
...
if optRichards:
    ...
    coefficients = ADR.Coefficients(nd,
                                    KsTypes,
                                    nVGtypes,
                                    alphaVGtypes,
                                    thetaRtypes,
                                    ...
                                    STABILIZATION_TYPE=0, #stabilization_type,
                                    ENTROPY_TYPE=1,
                                    LUMPED_MASS_MATRIX=True, #False,
                                    FCT=False,
                                    MONOLITHIC=False,
                                    num_fct_iter=1,
