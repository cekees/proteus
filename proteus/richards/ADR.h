...
namespace richards
{
  ...
  public:
	...
	/* Things to take care about:
	 - Take care of evaluate Coefficients
...
//          std::fill(elementResidual_u, elementResidual_u + nDOF_test_element, 0.0);
...
//              double m = 0.0, dm = 0.0;
//              double f[nSpace] = {0.0}, df[nSpace] = {0.0};
//              double a[nSpace][nSpace] = {{0.0}}, da[nSpace][nSpace] = {{0.0}};
//              // Calculate mapping
...
//                  for (int I = 0; I < nSpace; I++)
//                  {
//                      elementResidual_u[i] += (f[I] - a[I][I] * grad_u[I]) * dV * u_test_ref(k * nDOF_test_element + i);
//                  }
//              }
//          }

// //         // Apply element residual to global residual
//          for (int i = 0; i < nDOF_test_element; i++)
//          {
//              int eN_i = eN * nDOF_test_element + i;
//              globalResidual[u_l2g(eN_i)] += elementResidual_u[i];
//          }
//         // // Boundary integration (if needed)
//         // //for (int ebN = 0; ebN < nExteriorElementBoundaries_global; ebN++)
//         // //{
...
//         //         // Shape and solution information
//         //         double u_grad_trial_trace[nDOF_trial_element * nSpace];
//         //         ck.gradTrialFromRef(&u_grad_trial_trace_ref(ebN_local_kb * nDOF_trial_element), jacInv_ext, u_grad_trial_trace);
...
//         //         // PDE coefficients using solution and boundary values
//         //         double* a_ext = &ebqe_a(ebNE_kb * sd_rowptr[nSpace]);
//         //         double f_ext[nSpace], df_ext[nSpace], bc_f_ext[nSpace], bc_df_ext[nSpace];
//         //         for (int I = 0; I < nSpace; I++)
//         //         {
...
//         //         // Compute boundary integral contribution to element residual
         //         for (int i = 0; i < nDOF_test_element; i++)
         //         {
//         //             for (int I = 0; I < nSpace; I++)
//         //             {
...
//          // Apply element residual to global residual (boundary contribution)
//          for (int i = 0; i < nDOF_test_element; i++)
//          {
//              int eN_i = eN * nDOF_test_element + i;
//              globalResidual[u_l2g(eN_i)] += elementResidual_u[i];
...
//      //double metricTensorDetSqrt = args.scalar<double>("metricTensorDetSqrt");
//      for (int eN = 0; eN < nElements_global; eN++)
//      {
//         xt::pyarray<double> elementJacobian_u_u = xt::zeros<double>({nDOF_test_element, nDOF_trial_element});
//         xt::pyarray<double> element_u = xt::zeros<double>({nDOF_trial_element});
...
// 			    // Create double variables for constant values
//             double velocity[1] = {1.0};
//             //double r_value = 0.0;
...
//                     for (int I = 0; I < nSpace; I++)
//                     {
//                         elementJacobian_u_u(i, j) += (df[I] * u_grad_trial[j * nSpace + I] - a[I][I] * u_grad_trial[j * nSpace + I]) * dV * u_test_ref(k * nDOF_test_element + i);
//                     }
//                 }
//             }
//         }
